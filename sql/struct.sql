CREATE ROLE authapi LOGIN PASSWORD 'password';
...
GRANT SELECT, UPDATE, INSERT ON users TO authapi;
GRANT SELECT, USAGE ON SEQUENCE users_uid_seq TO authapi;
...
GRANT SELECT, UPDATE, INSERT, DELETE ON sessions TO authapi;
GRANT SELECT, USAGE ON SEQUENCE sessions_sid_seq TO authapi;
...
GRANT SELECT, INSERT, DELETE ON email_codes TO authapi;
GRANT SELECT, USAGE ON SEQUENCE email_codes_codeid_seq TO authapi;
